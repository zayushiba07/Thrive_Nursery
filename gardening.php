...
<div class="heading">
   ...
   <p style="text-decoration:5px underline; text-decoration-color:rgb(24, 234, 237);"> <a href="home.php" >Home</a> /<a href="shop.php"> Shop </a>/ Gardening Tools</p>
</div>
...
<section class="products">
   ...
   <div class="box-container">
      ...
      <?php
         $select_products = mysqli_query($conn, "SELECT * FROM `products` where p_type='Gradaning_Tools'") or die('query failed');

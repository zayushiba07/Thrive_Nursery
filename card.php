<?php
   ...
   $user_id=$_SESSION['user_id'];
    ...
    if(isset($_POST['sub']))
    {
        ...
        mysqli_query($conn, "INSERT INTO `orders`(user_id, name, number, email, address, product_name, total_price, placed_on , total_product, payment_status,method,order_status) VALUES('$user_id', '$name', '$number', '$email',  '$address', '$total_products', '$t_price', '$placed_on' , '$qty','Complete','Credit Card','Pending')") or die('query failed');
